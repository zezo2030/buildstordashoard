    ...
    <Modal title={`حذف ${kind === 'seller' ? 'البائع' : 'المشتري'}`} open onClose={onClose}>
      <div className="space-y-4">
        <p className="text-sm text-primary">
          ...
          {/* من غير السطر ده الأدمن مش عارف إن فيه طريق رجوع أصلاً — والحساب
              بيختفي من كل الفلاتر فيبان كأنه اتمسح خلاص. */}
          <span className="font-medium">
            وساعتها بيبان تحت فلتر «محذوف» في نفس الصفحة وترجّعه من زرار «استرجاع».
          </span>
        </p>
